...
LEDGER_ENABLED ?= true
BINDIR ?= $(GOPATH)/bin
STCEVM_BINARY = stcevmd
STCEVM_DIR = stcevm
BUILDDIR ?= $(CURDIR)/build
HTTPS_GIT := https://github.com/Jchicode/stcevm.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=stcevm \
          -X github.com/cosmos/cosmos-sdk/version.AppName=$(STCEVM_BINARY) \
...
PACKAGE_NAME:=github.com/Jchicode/stcevm
